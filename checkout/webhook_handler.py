...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        ...
        template = "checkout/emails/confirmation_email_subject.txt"
        context = {"order": order}
        email_subject = render_to_string(template, context)
        template = "checkout/emails/confirmation_email_body.txt"
        context = {
            "order": order,
    ...
    def handle_payment_succeeded(self, event):
        ...
        # Update user profile info if "save info" was checked
        profile = None
        ...
        if order_exists:
            ...
            return HttpResponse(content=response_message, status=HTTPStatus.OK)
        else:
            order = None
            try:
